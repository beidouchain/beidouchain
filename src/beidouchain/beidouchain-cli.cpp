...
/* MCHN START */    
    ...
    strUsage += "  -saveclilog=<n>          " + _("If <n>=0 beidouchain-cli history is not saved, default 1") + "\n";
/*    
...
//    ParseParameters(argc, argv);
        ...
        mc_gState->m_Params->m_NumArguments<minargs)
      {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  beidouchain-cli <blockchain-name> [options] <command> [params]  " + _("Send command to BeidouChain Core") + "\n" +
                  "  beidouchain-cli <blockchain-name> [options] help                " + _("List commands") + "\n" +
                  "  beidouchain-cli <blockchain-name> [options] help <command>      " + _("Get help for a command") + "\n";
...
*/
    ...
    SelectBeidouChainBaseParams(mc_gState->m_Params->NetworkName(),RPCPort);
    ...
    if(mc_gState->m_Params->m_NumArguments == 1)                                // Interactive mode
    {
        ...
        while(!exitnow && ((command=term->GetLine()) != NULL))
        {
            ...
            else
            {
                ...
                offset=0;
                argc_p=0;
                strcpy(dest+offset,"beidouchain-cli");
