...
#include "beidouchain/beidouchain.h"                                              // MCHN
...
/* MCHN START */
static boost::filesystem::path pathCachedBeidouChain;
...
/* MCHN START */
    ...
    pathCachedBeidouChain=fs::path(string(mc_gState->m_Params->DataDir()));
    fs::path &path =pathCachedBeidouChain;
    return path;
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "beidouchain.pid"));
