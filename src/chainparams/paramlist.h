...
#ifndef BEIDOUCHAINPARAMLIST_H
#define BEIDOUCHAINPARAMLIST_H

static const mc_OneBeidouchainParam BeidouchainParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: beidouchain (permissions, native assets) or bitcoin"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for beidouchaind and beidouchain-cli."},                   
