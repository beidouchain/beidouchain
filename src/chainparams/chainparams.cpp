...
/* MCHN START */
static Checkpoints::MapCheckpoints mapCheckpointsBeidouchain =
        boost::assign::map_list_of
        ( -1, uint256("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"))
        ;
static const Checkpoints::CCheckpointData dataBeidouchain = {
        &mapCheckpointsBeidouchain,
        0,
        0,
        0
    };
...
class CBeidouChainParams : public CMainParams {
public:
    CBeidouChainParams() {    };
    
    void SetFixedParams(const char *NetworkName)
    {
        networkID = CBaseChainParams::BEIDOUCHAIN;
...
//        convertSeed6(vFixedSeeds, pnSeed6_test, ARRAYLEN(pnSeed6_test));
    ...
    void SetBeidouChainRuntimeParams()
    {
...
//        assert(hashGenesisBlock == uint256("0x0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"));
    ...
    const Checkpoints::CCheckpointData& Checkpoints() const 
    {
        return dataBeidouchain;
    }
};
static CBeidouChainParams beidouChainParams;


bool SelectBeidouChainParams(const char *NetworkName)
{
    SelectBeidouChainBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));

    beidouChainParams.SetFixedParams(NetworkName);
    
    beidouChainParams.Initialize();
    
    pCurrentParams = &beidouChainParams;
...
void SetBeidouChainRuntimeParams()
{
    beidouChainParams.SetBeidouChainRuntimeParams();
}

bool InitializeBeidouChainParams()
{
    
    beidouChainParams.Initialize();
    
    beidouChainParams.SetGenesis();
