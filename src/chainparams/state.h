...
#ifndef BEIDOUCHAIN_STATE_H
#define	BEIDOUCHAIN_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/beidouchainscript.h"
...
{    
    ...
    mc_Params               *m_Params;
    mc_BeidouchainParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_BeidouchainParams;
        m_Permissions=NULL;
        m_Assets=NULL;
